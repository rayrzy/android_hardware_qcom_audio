 ...
 */
__attribute__((visibility("default"))) int offload_effects_bundle_hal_start_output(audio_io_handle_t output, int pcm_id, struct mixer *mixer) {
  int ret = 0;
  struct listnode *node;
...
__attribute__((visibility("default"))) int offload_effects_bundle_hal_stop_output(audio_io_handle_t output, int pcm_id) {
  int ret = -1;
  struct listnode *node;
  struct listnode *fx_node;
...
__attribute__((visibility("default"))) int offload_effects_bundle_set_hpx_state(bool hpx_state) {
  int ret = 0;
  struct listnode *node;
 ...
 */
__attribute__((visibility("default"))) void offload_effects_bundle_get_parameters(struct str_parms *query,
                                                                                  struct str_parms *reply) {
  asphere_get_parameters(query, reply);
}

__attribute__((visibility("default"))) void offload_effects_bundle_set_parameters(struct str_parms *parms) {
...
int effect_command(effect_handle_t self, uint32_t cmdCode, uint32_t cmdSize,
  ...
  switch (cmdCode) {
    ...
    case EFFECT_CMD_OFFLOAD: {
      ...
      if (cmdSize != sizeof(effect_offload_param_t) || pCmdData == NULL || pReplyData == NULL || *replySize != sizeof(int)) {
    ...
    case EFFECT_CMD_HW_ACC: {
      ...
      if (cmdSize != sizeof(uint32_t) || pCmdData == NULL || pReplyData == NULL || *replySize != sizeof(int)) {
        return -EINVAL;
      }
